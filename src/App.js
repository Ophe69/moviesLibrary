...
// notre tableau de données 
  ...
  /* on fait une mapp pour remplir le tableau movieList. chaque objet = movie et il a donc plusieurs couples clé/valeur.
  le return de la function map donnera des propriétés au composant <Movie/> ce qui permettra au child de recevoirles propriétés
  déterminées dans le parent "movieName={movie.name}" on choisi le nom de la propriété et on y lie une valeur du tableau */
  ...
  return (       // le return de la fonction principale est en jsx et sert à afficher a quoi devrait ressembler l'UI 
    <div style={{backgroundColor:"#232528"}}>
      <Container>
        ...
        <Row>
          {movieList}  {/* appel de la liste qui contient tous les <Movie/> */}
        </Row>
      </Container>
    </div>
  );
